...
# Indexes
#
#  index_property_ad_allocations_on_place_id  (place_id) UNIQUE
#
class PropertyAdAllocation < ApplicationRecord
  ...
  def self.create_or_update(params)
    ...
    property_ad_allocation = find_by(place_id: place_id)
    
    if property_ad_allocation.present?
      ...
      property_ad_allocation.update!(params)
    else
      property_ad_allocation = create!(params)
    end
